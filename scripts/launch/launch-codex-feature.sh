#!/usr/bin/env bash
# Read-only session starter: Codex, feature-build mode.
# Usage: launch-codex-feature.sh [TASK-ID]
# Modifies nothing; prints context + safety rules; opens `codex` if installed.
set -euo pipefail
...
cat <<'BANNER'
==============================================================
  AI TEAM MEMORY CORE — Codex / FEATURE-BUILD mode
==============================================================
...
echo "  2. agents/codex/ROLE.md"
echo "  3. memory/agents/CODEX_MEMORY.md"
...
if command -v codex >/dev/null 2>&1; then
  ...
  echo "Codex CLI not found on this machine."
